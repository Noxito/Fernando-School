                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($proveedores_datos as $proveedores_dato) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="https://wa.me/51<?php echo $proveedores_dato['celular']; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $contador_de_compras; ?>"
                                                    style="text-align: center" class="form-control" disabled>
                                                <input type="text" value="<?php echo $contador_de_compras; ?>"
                                                    id="nro_compra" hidden>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="background-color: #fff819;text-align: center"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="cantidad_compra" style="text-align: center"
                                                    class="form-control">
                                            </div>
                                            <script>
