                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data_card_widget="collapse"><i
                                        ...
                                        foreach ($productos_datos as $productos_dato) {
                                            ...
                                            <tr>
                                                ...
                                                if($stock_actual < $stock_minimo){ ?>
                                                    <td style="background-color: #FA4B4B"><center><?php echo $productos_dato['stock']; ?></center></td>
                                                <?php
                                                }
                                                else if($stock_actual > $stock_maximo){ ?>
                                                    <td style="background-color: #4AA339"><center><?php echo $productos_dato['stock']; ?></center></td>
                                                <?php
                                                }else{ ?>
